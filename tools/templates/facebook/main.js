(function () {
  ...
  if (window.document) {
    var cdnUrl = 'https://storage.googleapis.com/rgames-portal-jp-production.appspot.com/static/libs/cocos2d-js/1.0.0/cocos2d-js-min.js';
    var splash = document.getElementById('splash');
    splash.style.display = 'block';

    var cocos2d = document.createElement('script');
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : cdnUrl;
    ...
    var engineLoadError = function () {
      cocos2d.removeEventListener('load', engineLoaded, false);
      cocos2d.removeEventListener('error', engineLoadError, false);
      document.body.removeChild(cocos2d);
      cocos2d = document.createElement('script');
      cocos2d.src = 'cocos2d-js-min.js';
      cocos2d.addEventListener('load', engineLoaded, false);
      cocos2d.addEventListener('error', engineLoadError, false);
